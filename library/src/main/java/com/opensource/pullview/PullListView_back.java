 ...
 */
public class PullListView_back extends ListView implements IPullView, AbsListView.OnScrollListener {
	 ...
	 * @param context
	 */
	public PullListView_back(Context context) {
		super(context);
		initView(context);
	}
	 ...
	 * @param context
	 */
	public PullListView_back(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	 ...
	 * @param context
	 */
    public PullListView_back(Context context, AttributeSet attrs, int defStyle) {
	 ...
	 * <p>can use value is {@link com.opensource.pullview.PullListView_back.LoadMode#AUTO_LOAD} and {@link com.opensource.pullview.PullListView_back.LoadMode#PULL_TO_LOAD}<br>
	 * default is {@link com.opensource.pullview.PullListView_back.LoadMode#AUTO_LOAD}
	 * @param mode
	 * @see {@link com.opensource.pullview.PullListView_back.LoadMode}
	 */
	 ...
	 * <p>The value of {@link #mLastRefreshTime} initialized to the time when create {@link com.opensource.pullview.PullListView_back} object.<br>
